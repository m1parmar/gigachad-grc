...
# Or manually:
docker-compose down
docker volume rm gigachad-grc_postgres_data gigachad-grc_redis_data gigachad-grc_rustfs_data
rm -rf storage/
```
...
# Backup RustFS (evidence files)
docker cp grc-rustfs:/data/grc-evidence ./rustfs-backup/
...
# Restore RustFS
docker cp ./rustfs-backup/grc-evidence/. grc-rustfs:/data/grc-evidence/
```
