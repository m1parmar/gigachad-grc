...
openssl rand -base64 20 > /tmp/rustfs_password
...
# RustFS/S3 credentials (use generated value)
MINIO_ROOT_PASSWORD=$(cat /tmp/rustfs_password)
...
### Configure RustFS Object Storage
...
1. Access RustFS console:
   ...
   - Username: Value from `MINIO_ROOT_USER` (default: rustfsadmin)
