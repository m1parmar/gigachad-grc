...
export async function mapRequirements(params) {
...
function generateMockMappings(controlId, control, targetFrameworks, confidenceThreshold) {
    const mappings = [];
    const unmappedFrameworks = [];
...
function generateEnhancements(mappings, unmapped) {
    const enhancements = [];
...
//# sourceMappingURL=requirement-mapper.js.map