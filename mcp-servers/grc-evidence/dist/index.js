    ...
    try {
        ...
        switch (name) {
            case 'collect_aws_evidence':
                result = await collectAWSEvidence(toolArgs);
                break;
            case 'collect_azure_evidence':
                result = await collectAzureEvidence(toolArgs);
                break;
            case 'collect_github_evidence':
                result = await collectGitHubEvidence(toolArgs);
                break;
            case 'collect_okta_evidence':
                result = await collectOktaEvidence(toolArgs);
                break;
            case 'scan_vulnerability':
                result = await scanVulnerabilities(toolArgs);
                break;
            case 'capture_screenshot':
                result = await captureScreenshot(toolArgs);
                break;
            case 'collect_google_workspace_evidence':
                result = await collectGoogleWorkspaceEvidence(toolArgs);
                break;
            case 'collect_jamf_evidence':
                result = await collectJamfEvidence(toolArgs);
                break;
            default:
