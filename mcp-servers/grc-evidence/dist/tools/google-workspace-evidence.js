export async function collectGoogleWorkspaceEvidence(params) {
    const { checks = ['admin-audit', 'login-audit', 'drive-sharing', 'mobile-devices'], timeRange, } = params;
    const findings = [];
...
async function collectAdminAuditLogs(timeRange) {
...
async function collectLoginAuditLogs(timeRange) {
...
async function collectDriveSharingSettings() {
